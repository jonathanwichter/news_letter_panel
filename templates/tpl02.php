...
$content .= "<table bgcolor='#ffffff' border='0' cellspacing='0' cellpadding='0' width='600' align='center'><tr>\n";
$content .= "<td align='center'><table border='0' cellspacing='0' cellpadding='0' width='100%'><tr>\n";
$content .= "<td align='center' width='600' height='18' background='".$settings['siteurl']."infusions/news_letter_panel/images/tmpl02/top.jpg' alt='' border='0' style='display: block;'></td></tr><tr>\n";
$content .= "<td align='center' valign='top' background='".$settings['siteurl']."infusions/news_letter_panel/images/tmpl02/mid.jpg' alt='' border='0' style='display: block;'>\n";
...
$content .= "<tr><td background='".$settings['siteurl']."infusions/news_letter_panel/images/tmpl02/mid.jpg' alt='' border='0' style='display: block;'>\n";
...
$content .= "<tr><td align='center' background='".$settings['siteurl']."infusions/news_letter_panel/images/tmpl02/mid.jpg' alt='' border='0' style='display: block;'>\n";
$content .= "<span style='color:#000000; font-size: 11px;'>".$locale['nl_920']."</span><a style='color: #000099;' href='mailto:".$settings['siteemail']."'><span style='color:#000099; font-size: 11px;'>".$locale['nl_923']."</span></a><span style='color:#000000; font-size: 11px;'>".$locale['nl_921']."</span><br><br>\n";
$content .= "<span style='color:#000000; font-size: 11px;'>".$locale['nl_900']." ".$settings['sitename']."<br>".$locale['nl_924']."</span><a style='color: #000099;' href='".$settings['siteurl']."'><span style='color:#000099; font-size: 11px;'>".$settings['siteurl']."</span></a>\n";
$content .= "<span style='color:#000000; font-size: 11px;'>".$locale['nl_901']."</span></td></tr>\n";
$content .= "<tr><td width='600' height='18' background='".$settings['siteurl']."infusions/news_letter_panel/images/tmpl02/bot.jpg' alt='' border='0' style='display: block;'></td></tr></table>\n";
$content .= "</td></tr></table>\n";
...
$content .= " <a style='color: #000040;' href='".$settings['siteurl']."privacy_policy.php'><span style='color:#000099; font-size: 11px;'>".$locale['nl_904']."</span></a>\n";
$content .= "<br><br></td></tr></table>\n";
$content .= "</td></tr></table>\n";
$content .= "</body></html>\n";
?>